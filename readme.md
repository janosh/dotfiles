# macOS Setup Automation [![pre-commit.ci status](https://results.pre-commit.ci/badge/github/janosh/dotfiles/main.svg)](https://results.pre-commit.ci/latest/github/janosh/dotfiles/main)
